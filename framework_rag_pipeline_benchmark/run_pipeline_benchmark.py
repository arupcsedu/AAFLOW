...
from .common import BenchmarkConfig, ensure_synthetic_corpus, write_metrics
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--vector-backend", choices=["fake", "chroma"], default="fake")
...
def main() -> None:
    ...
    write_metrics(Path(args.output_dir), rows)
